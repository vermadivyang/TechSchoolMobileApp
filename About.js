...
const image = {
     uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSdwJNwqYm55hOOJmeSxsKYdBURy405H_dLeA&usqp=CAU" ,
    width: 375 ,
    height: 100
};
const reading = {
...
<ScrollView style={{backgroundColor:'#e3ecff',}}>
    ...
    <View>
      ...
      <Text style={{fontSize: 30,}}></Text>
            <Text style={styles.HeaderT}>Staff</Text>
      <Text style={{fontSize: 30,}}></Text>
      <Text style={{fontSize: 30,}}></Text>
      </ImageBackground>
      <Text></Text>
      ...
      <Text></Text>
      <Text></Text>
      <Card title="Mrs. Principle" imageS={require('./Assets/PrinceableM.jpg')} content="      Mrs. Principle has been the school principle for 6 years. Before that, she was a music teacher at Tech school. She enjoys planting flowers and reading with her dog, Mr. Roof."/>
      <Text></Text>
      <Card title="Mr. Math&Science" imageS={require('./Assets/UpFaceCap.jpg')} content="        Mr. Math&Science has been at the school for 5 years. Before that he was a Professer at Tech University. He loves solving problems and coding."/>
      <Text></Text>
      <Card title="Mrs. English" imageS={require('./Assets/EnlishTeach.jpg')} content="       Mrs. English has been at the school for 4 years. Before that, she went to business. She loves painting, and writing books."/>
      <Text></Text>
      <Card title="Mrs. Art&Music" imageS={require('./Assets/ArtTeach.jpg')} content="     Mrs. Art&Music has been at the school for only 2 years. This is her frist job. She likes watching TV, and playing with childen."/>
      <Text></Text>
      <Card title="Mr. Gym" imageS={require('./Assets/UpFaceCap.jpg')} content="     Mr. Gym has been at the school for 4 years. Before that, he worked at a gym. He likes running, and hiking."/>
