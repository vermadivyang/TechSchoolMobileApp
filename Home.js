...
const image = {
  uri: "https://3.files.edl.io/ad8b/20/12/16/185736-02b6057e-664f-4a74-94de-c41b713053d4.jpg" 
};
const reading = {
...
const HomeScreen = props => {
    return (
      ...
      <View style={styles.container}>
        ...
        <Text/>
        <Text/>
          <Text style={{fontSize: 19, marginLeft: 13, marginRight:10 ,}} >         At Tech School, it is our job to teach kids how to grow smart, kind, and healthy. We give kids proper education with problem solving skills and reading abilites. We have a gym where kids can learn sports and how to stay fit. We also have a cafeteria , with healthy foods. Your child may bring his/her own lunch. We teach kindergarden to 5th grade.</Text>
        <Text/>
        <Text/>
        <Text/>
          ...
          <Text style={{  marginLeft: 30, fontSize: 20,  marginTop: 10, color: "blue"}} onPress={() => Linking.openURL('https://www.sjschools.org/images/District/Community%20Cork%20Board/2021PARENTCALENDAR.pdf')}>Year_2021</Text>
          <Text style={{  marginLeft: 30, fontSize: 20,  marginTop: 5, color: "blue"}} onPress={() => Linking.openURL('http://google.com')}>LunchYear_2021</Text>
          <Text style={{  marginLeft: 30, fontSize: 20,  marginTop: 5, color: "blue"}} onPress={() => Linking.openURL('http://google.com')}>Drills & specials</Text>
