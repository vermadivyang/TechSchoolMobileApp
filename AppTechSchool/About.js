...
<ScrollView style={{backgroundColor:'#e3ecff',}}>
    ...
    <View>
      ...
      <Text></Text>
      <Card title="Mr.Math&Science" imageS={require('./Assets/UpFaceCap.jpg')} content="        Mr.Math&Science has been at the school for 5 years. Before that he was a Professer at Tech Univerity. He loves solving problems and coding."/>
      <Text></Text>
      <Card title="Mrs.Enlish" imageS={require('./Assets/EnlishTeach.jpg')} content="       Mrs.Enlish has been at the school for 4 years. Before that, she went to bissness. She loves painting, and writing books."/>
      <Text></Text>
      <Card title="Mrs.Art&Music" imageS={require('./Assets/ArtTeach.jpg')} content="     Mrs.Art&Music has been at the school for only 2 years. This is her frist job. She likes whacting TV, and playing with childen."/>
      <Text></Text>
